...
export declare const redeemBid: ({ connection, wallet, store, auction, }: IRedeemBidParams) => Promise<IRedeemBidResponse>;
...
export declare const getRedeemBidTransactions: ({ accountRentExempt, bidder, tokenMint, store, vault, auction, auctionManager, auctionExtended, bidRedemption, bidderMeta: bidMetadata, safetyDepositTokenStore, safetyDeposit, fractionMint, safetyDepositConfig, transferAuthority, metadata, }: IRedeemBidTransactionsParams) => Promise<TransactionsBatch>;
