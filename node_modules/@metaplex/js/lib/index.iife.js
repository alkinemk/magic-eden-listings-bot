var metaplex = (function (exports, web3_js, splToken) {
  ...
  ***************************************************************************** */
      ...
      static getMultipleAccounts(connection, pubkeys, commitment) {
          return __awaiter(this, void 0, void 0, function* () {
              ...
              const infos = unsafeRes.result.value
                  .filter(Boolean)
                  .map((info) => (Object.assign(Object.assign({}, info), { data: buffer.Buffer.from(info.data[0], 'base64') })));
  ...
  var deserializeUnchecked_1 = lib$1.deserializeUnchecked = deserialize_1 = lib$1.deserialize = serialize_1 = lib$1.serialize = BinaryReader_1 = lib$1.BinaryReader = BinaryWriter_1 = lib$1.BinaryWriter = lib$1.BorshError = lib$1.baseDecode = lib$1.baseEncode = void 0;
  ...
  var BinaryWriter_1 = lib$1.BinaryWriter = BinaryWriter;
  ...
  var BinaryReader_1 = lib$1.BinaryReader = BinaryReader;
  ...
  function deserialize$3(schema, classType, buffer) {
  ...
  var deserialize_1 = lib$1.deserialize = deserialize$3;
  ...
  class Data {
      ...
      static serialize(args = {}) {
          return Buffer.from(serialize_1(this.SCHEMA, new this(args)));
      }
      static deserialize(data) {
          return deserializeUnchecked_1(this.SCHEMA, this, data);
      }
  }
  ...
  var borsh = /*#__PURE__*/Object.freeze({
    ...
    Data: Data,
    struct: struct,
    get deserialize () { return deserialize_1; },
    get deserializeUnchecked () { return deserializeUnchecked_1; },
    get serialize () { return serialize_1; }
  });
  ...
  class BidderMetadata extends Account {
      ...
      static getPDA(auction, bidder) {
          return AuctionProgram.findProgramAddress([
              ...
              new web3_js.PublicKey(bidder).toBuffer(),
  ...
  class PriceFloor extends Data {
      constructor(args) {
          ...
          if (this.type === PriceFloorType.Minimum) {
              if (args.minPrice) {
                  this.hash.set(args.minPrice.toArrayLike(buffer.Buffer, 'le', 8), 0);
              }
              else {
              ...
              return (yield AuctionProgram.getProgramAccounts(connection, {
                  filters: [
                      filters.authority && {
                          memcmp: {
                              offset: 0,
                              bytes: new web3_js.PublicKey(filters.authority).toBase58(),
                          },
                      },
                  ].filter(Boolean),
              }))
      ...
      constructor(options, params) {
          ...
          this.add(new web3_js.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js.SYSVAR_CLOCK_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
                  ...
                  filters: [
                      {
                          memcmp: {
                              offset: 0,
                              bytes: bs58.encode(buffer.Buffer.from([MetaplexKey.AuctionManagerV2])),
                          },
                      },
                      filters.store && {
                          memcmp: {
                              offset: 1,
                              bytes: new web3_js.PublicKey(filters.store).toBase58(),
                          },
                      },
                      filters.authority && {
                          memcmp: {
                  ...
                  filters: [
                      {
                          memcmp: {
                              offset: 0,
                              bytes: bs58.encode(buffer.Buffer.from([MetaplexKey.BidRedemptionTicketV2])),
                          },
                      },
                      {
                          memcmp: {
                  ...
                  filters: [
                      {
                          memcmp: {
                              offset: 0,
                              bytes: bs58.encode(buffer.Buffer.from([MetaplexKey.PayoutTicketV1])),
                          },
                      },
                      {
                          memcmp: {
                  ...
                  filters: [
                      {
                          memcmp: {
                              offset: 0,
                              bytes: bs58.encode(buffer.Buffer.from([MetaplexKey.WhitelistedCreatorV1])),
                          },
                      },
                  ],
      ...
      static getPDA(auctionManager) {
          return __awaiter(this, void 0, void 0, function* () {
              return MetaplexProgram.findProgramAddress([
                  ...
                  MetaplexProgram.PUBKEY.toBuffer(),
                  new web3_js.PublicKey(auctionManager).toBuffer(),
                  buffer.Buffer.from(MetaplexProgram.TOTALS),
              ]);
          });
      }
  }
                  ...
                  filters: [
                      {
                          memcmp: {
                              offset: 0,
                              bytes: bs58.encode(buffer.Buffer.from([VaultKey.SafetyDepositBoxV1])),
                          },
                      },
                      {
                          memcmp: {
                  ...
                  filters: [
                      {
                          memcmp: {
                              offset: 0,
                              bytes: bs58.encode(buffer.Buffer.from([MetadataKey.EditionV1])),
                          },
                      },
                      {
                          memcmp: {
  ...
  class TokenAccount extends Account {
      constructor(pubkey, info) {
          super(pubkey, info);
          if (!this.assertOwner(splToken.TOKEN_PROGRAM_ID)) {
              throw ERROR_INVALID_OWNER();
          }
      ...
      static isCompatible(data) {
          return data.length === splToken.AccountLayout.span;
      }
      static getTokenAccountsByOwner(connection, owner) {
          return __awaiter(this, void 0, void 0, function* () {
              return (yield connection.getTokenAccountsByOwner(new web3_js.PublicKey(owner), {
  ...
  class CreateTokenAccount extends Transaction {
      constructor(options, params) {
          ...
          this.add(splToken.Token.createInitAccountInstruction(splToken.TOKEN_PROGRAM_ID, mint, newAccountPubkey, owner !== null && owner !== void 0 ? owner : feePayer));
      }
  }
              ...
              const baseFilters = [
                  {
                      memcmp: {
                          offset: 0,
                          bytes: bs58.encode(buffer.Buffer.from([MetadataKey.MetadataV1])),
                      },
                  },
                  filters.updateAuthority && {
                      memcmp: {
                          offset: 1,
                          bytes: new web3_js.PublicKey(filters.updateAuthority).toBase58(),
                      },
                  },
                  filters.mint && {
                      memcmp: {
                          offset: 33,
                          bytes: new web3_js.PublicKey(filters.mint).toBase58(),
                      },
                  },
              ].filter(Boolean);
              if (filters.creators) {
                          ...
                          filters: [
                              ...baseFilters,
                              {
                                  memcmp: {
                                      ...
                                      bytes: new web3_js.PublicKey(pubkey).toBase58(),
                                  },
                              },
                          ],
                      })),
  ...
  const initStore = ({ connection, wallet, isPublic = true, }) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const tx = new SetStore({ feePayer: wallet.publicKey }, {
          admin: new web3_js.PublicKey(wallet.publicKey),
          store: storeId,
          isPublic,
      });
  ...
  function prepareTokenAccountAndMintTx(connection, owner) {
      return __awaiter(this, void 0, void 0, function* () {
          ...
          const mintRent = yield connection.getMinimumBalanceForRentExemption(splToken.MintLayout.span);
          const createMintTx = new CreateMint({ feePayer: owner }, {
              newAccountPubkey: mint.publicKey,
              lamports: mintRent,
          });
          const recipient = yield splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, mint.publicKey, owner);
  ...
  const mintEditionFromMaster = ({ connection, wallet, masterEditionMint, updateAuthority } = {}) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const { mint, createMintTx, createAssociatedTokenAccountTx, mintToTx } = yield prepareTokenAccountAndMintTx(connection, wallet.publicKey);
      const tokenAccount = yield splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, masterEditionMint, wallet.publicKey);
      const metadataPDA = yield Metadata.getPDA(mint.publicKey);
  ...
  const closeVault = ({ connection, wallet, vault, priceMint, }) => __awaiter(void 0, void 0, void 0, function* () {
      const accountRent = yield connection.getMinimumBalanceForRentExemption(splToken.AccountLayout.span);
      ...
      const fractionMintKey = new web3_js.PublicKey(fractionMint);
      const fractionTreasuryKey = new web3_js.PublicKey(fractionTreasury);
      const redeemTreasuryKey = new web3_js.PublicKey(redeemTreasury);
      const pricingLookupAddressKey = new web3_js.PublicKey(pricingLookupAddress);
      ...
      const outstandingShareAccount = web3_js.Keypair.generate();
      ...
      const payingTokenAccount = web3_js.Keypair.generate();
      ...
      const transferAuthority = web3_js.Keypair.generate();
      const createApproveTx = (account) => new Transaction().add(splToken.Token.createApproveInstruction(splToken.TOKEN_PROGRAM_ID, account.publicKey, transferAuthority.publicKey, wallet.publicKey, [], 0));
  ...
  const createVault = ({ connection, wallet, priceMint = splToken.NATIVE_MINT, externalPriceAccount, }) => __awaiter(void 0, void 0, void 0, function* () {
      const accountRent = yield connection.getMinimumBalanceForRentExemption(splToken.AccountLayout.span);
      const mintRent = yield connection.getMinimumBalanceForRentExemption(splToken.MintLayout.span);
      const vaultRent = yield connection.getMinimumBalanceForRentExemption(Vault.MAX_VAULT_SIZE);
      const vault = web3_js.Keypair.generate();
      const vaultAuthority = yield Vault.getPDA(vault.publicKey);
      const txBatch = new TransactionsBatch({ transactions: [] });
      const fractionMint = web3_js.Keypair.generate();
      ...
      const redeemTreasury = web3_js.Keypair.generate();
      ...
      const fractionTreasury = web3_js.Keypair.generate();
      ...
      const uninitializedVaultTx = new Transaction().add(web3_js.SystemProgram.createAccount({
  ...
  const createExternalPriceAccount = ({ connection, wallet, }) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const externalPriceAccount = web3_js.Keypair.generate();
      const externalPriceAccountData = new ExternalPriceAccountData({
          pricePerShare: new BN(0),
          priceMint: splToken.NATIVE_MINT.toBase58(),
          allowedToCombine: true,
      });
      const uninitializedEPA = new Transaction().add(web3_js.SystemProgram.createAccount({
          fromPubkey: wallet.publicKey,
  ...
  const cancelBid = ({ connection, wallet, auction, bidderPotToken, destAccount, }) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const auctionTokenMint = new web3_js.PublicKey(tokenMint);
      const vault = new web3_js.PublicKey(manager.data.vault);
      ...
      const accountRentExempt = yield connection.getMinimumBalanceForRentExemption(splToken.AccountLayout.span);
  ...
  const getCancelBidTransactions = ({ destAccount, bidder, accountRentExempt, bidderPot, bidderPotToken, bidderMeta, auction, auctionExtended, auctionTokenMint, vault, }) => __awaiter(void 0, void 0, void 0, function* () {
      const txBatch = new TransactionsBatch({ transactions: [] });
      if (!destAccount) {
          const account = web3_js.Keypair.generate();
          const createTokenAccountTransaction = new CreateTokenAccount({ feePayer: bidder }, {
              newAccountPubkey: account.publicKey,
              lamports: accountRentExempt,
              mint: splToken.NATIVE_MINT,
          });
          const closeTokenAccountInstruction = new Transaction().add(splToken.Token.createCloseAccountInstruction(splToken.TOKEN_PROGRAM_ID, account.publicKey, bidder, bidder, []));
  ...
  const placeBid = ({ connection, wallet, amount, auction, bidderPotToken, }) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const payingAccount = web3_js.Keypair.generate();
      const createTokenAccountTransaction = new CreateTokenAccount({ feePayer: bidder }, {
          newAccountPubkey: payingAccount.publicKey,
          lamports: amount.toNumber() + accountRentExempt * 3,
          mint: splToken.NATIVE_MINT,
      });
      const closeTokenAccountTransaction = new Transaction().add(splToken.Token.createCloseAccountInstruction(splToken.TOKEN_PROGRAM_ID, payingAccount.publicKey, bidder, bidder, []));
      txBatch.addTransaction(createTokenAccountTransaction);
      txBatch.addAfterTransaction(closeTokenAccountTransaction);
      txBatch.addSigner(payingAccount);
      const transferAuthority = web3_js.Keypair.generate();
      const createApproveTransaction = new Transaction().add(splToken.Token.createApproveInstruction(splToken.TOKEN_PROGRAM_ID, payingAccount.publicKey, transferAuthority.publicKey, bidder, [], amount.toNumber()));
      txBatch.addTransaction(createApproveTransaction);
      const createRevokeTransaction = new Transaction().add(splToken.Token.createRevokeInstruction(splToken.TOKEN_PROGRAM_ID, payingAccount.publicKey, bidder, []));
  ...
  const redeemBid = ({ connection, wallet, store, auction, }) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const fractionMint = new web3_js.PublicKey(vault.data.fractionMint);
      ...
      const tokenMint = new web3_js.PublicKey(safetyDepositBox.data.tokenMint);
      const safetyDepositTokenStore = new web3_js.PublicKey(safetyDepositBox.data.store);
      const bidderMeta = yield BidderMetadata.getPDA(auction, bidder);
  ...
  const getBidRedemptionPDA = (auction, bidderMeta) => __awaiter(void 0, void 0, void 0, function* () {
      return (yield web3_js.PublicKey.findProgramAddress([Buffer.from(MetaplexProgram.PREFIX), auction.toBuffer(), bidderMeta.toBuffer()], MetaplexProgram.PUBKEY))[0];
  });
  ...
  const claimBid = ({ connection, wallet, store, auction, bidderPotToken, }) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const acceptPayment = new web3_js.PublicKey(manager.data.acceptPayment);
      const auctionExtended = yield AuctionExtended.getPDA(vault);
      const auctionTokenMint = new web3_js.PublicKey(tokenMint);
      const bidderPot = yield BidderPot.getPDA(auction, bidder);
  ...
  const instantSale = ({ connection, wallet, store, auction, }) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const fractionMint = new web3_js.PublicKey(vault.data.fractionMint);
      const [safetyDepositBox] = yield vault.getSafetyDepositBoxes(connection);
      const metadataTokenMint = new web3_js.PublicKey(safetyDepositBox.data.tokenMint);
      const safetyDepositTokenStore = new web3_js.PublicKey(safetyDepositBox.data.store);
      const safetyDepositConfig = yield SafetyDepositConfig.getPDA(auctionManager, safetyDepositBox.pubkey);
      const transferAuthority = yield Vault.getPDA(vault.pubkey);
  ...
  const burnToken = ({ connection, wallet, token, mint, amount, owner, close = true, }) => __awaiter(void 0, void 0, void 0, function* () {
      const tx = new Transaction({ feePayer: wallet.publicKey }).add(splToken.Token.createBurnInstruction(splToken.TOKEN_PROGRAM_ID, mint, token, owner !== null && owner !== void 0 ? owner : wallet.publicKey, [], amount));
      if (close) {
          tx.add(splToken.Token.createCloseAccountInstruction(splToken.TOKEN_PROGRAM_ID, token, wallet.publicKey, owner !== null && owner !== void 0 ? owner : wallet.publicKey, []));
      }
      const txId = yield sendTransaction({ connection, wallet, txs: [tx] });
      return { txId };
  });
  ...
  const sendToken = ({ connection, wallet, source, destination, mint, amount, }) => __awaiter(void 0, void 0, void 0, function* () {
      const txs = [];
      const destAta = yield splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, mint, destination);
      ...
      txs.push(new Transaction(transactionCtorFields).add(splToken.Token.createTransferInstruction(splToken.TOKEN_PROGRAM_ID, source, destAta, wallet.publicKey, [], amount)));
